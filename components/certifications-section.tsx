  ...
  const certifications = [
    {
      ...
      issuer: "HackerRank",
      description:
        "Validated core Java programming concepts through hands-on coding assessments",
      date: "2024",
      certificateUrl:
        "https://www.hackerrank.com/certificates/iframe/8da4ca4e1c3b",
      image: "/javabasic.png",
      skills: [
    ...
    },
    {
      ...
      issuer: "HackerRank",
      description:
        "Demonstrated proficiency in JavaScript fundamentals, DOM manipulation, and ES6 features",
      date: "2024",
      certificateUrl:
        "https://www.hackerrank.com/certificates/iframe/52ba849c7e13d",
      image: "/jsbc.png",
    ...
    },
    {
      ...
      issuer: "HackerRank",
      description:
        "Validated intermediate SQL skills including query optimization, joins, subqueries, and advanced filtering",
      date: "2024",
      certificateUrl:
        "https://www.hackerrank.com/certificates/iframe/0c86854664bd",
      image: "/sqlic.png",
      skills: [
        "Joins",
        "Subqueries",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="fade-in-up text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
            Validated skills and expertise through industry-recognized
            certifications
          </p>
        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {certifications[currentIndex].skills.map(
                            (skill, skillIndex) => (
                              <Badge
                                key={skillIndex}
                                variant="secondary"
                      ...
                      <Button asChild className="w-full sm:w-auto hover-lift">
                        <a
                          href={certifications[currentIndex].certificateUrl}
                          target="_blank"
