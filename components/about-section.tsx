          ...
          <div className="fade-in-up stagger-1">
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-pretty">
                ...
                innovative solutions that push the boundaries of what's possible with web development and system
                architecture.
              </p>
            </div>
          </div>
            ...
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/10">
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-primary/10">
                  <p className="text-center text-muted-foreground">"Building the future, one line of code at a time"</p>
                </div>
              </div>
            </Card>
          </div>
